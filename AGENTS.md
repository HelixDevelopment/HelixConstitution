...
| Status | active |
| Status summary | Mirrored Constitution.md §11.4.73 (main-spec versioning + revision discipline) and §11.4.74 (submodule-catalogue-first discovery) into this AGENTS.md per the new mandates' cross-document propagation requirement. |
| Issues | none |
| Issues summary | — |
