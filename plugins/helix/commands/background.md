---
description: "Run the remainder of the prompt as a DURABLE (never-lost), background, subagent-driven work stream in parallel with all main work, producing rock-solid physical proof."
...
<!-- Source of truth: actions/registry.yaml action BACKGROUND. Re-run the generator to update. -->
