#!/usr/bin/env bash
# skills/reporting-workable-items/register.sh
#
# Purpose:   Register the 'reporting-workable-items' skill in a consuming project by
...
# Outputs:   <project>/.claude/skills/reporting-workable-items -> this directory. Exit 0 on success.
...
exec bash "$const_root/scripts/install_cli_agent_plugins.sh" "${1:-$PWD}" --skill "reporting-workable-items"
