#!/usr/bin/env bash
# cm_covenant_114_230_propagation.sh — CM-COVENANT-114-230-PROPAGATION gate (anchor §11.4.230).
#
# ── Purpose ──────────────────────────────────────────────────────────────────
# §11.4.227(B) anchor-block integrity for §11.4.230: the anchor's BLOCK (its
# own governance paragraph, not merely the bare literal `11.4.230`) MUST be
...
#
# ── Cross-references ─────────────────────────────────────────────────────────
#   §11.4.230 (the anchor enforced), §11.4.227(A)/(B), §11.4.201(1)/(7)(a)/(7)(b),
