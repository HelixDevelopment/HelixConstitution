#!/usr/bin/env bash
# cm_covenant_114_231_propagation.sh — CM-COVENANT-114-231-PROPAGATION gate (anchor §11.4.231).
#
# ── Purpose ──────────────────────────────────────────────────────────────────
# §11.4.227(B) anchor-block integrity for §11.4.231: the anchor's BLOCK (its
# own governance paragraph, not merely the bare literal `11.4.231`) MUST be
...
#
# ── Cross-references ─────────────────────────────────────────────────────────
#   §11.4.231 (the anchor enforced), §11.4.227(A)/(B), §11.4.201(1)/(7)(a)/(7)(b),
