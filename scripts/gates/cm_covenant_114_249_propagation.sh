#!/usr/bin/env bash
# cm_covenant_114_249_propagation.sh — CM-COVENANT-114-249-PROPAGATION gate (anchor §11.4.249).
#
# ── Purpose ──────────────────────────────────────────────────────────────────
# §11.4.227(B) anchor-block integrity for §11.4.249: the anchor's BLOCK (its
# own governance paragraph, not merely the bare literal `11.4.249`) MUST be
...
#
# ── Usage ────────────────────────────────────────────────────────────────────
#   cm_covenant_114_249_propagation.sh [--root <consumer-root>] [--quiet]
...
#
# ── Cross-references ─────────────────────────────────────────────────────────
#   §11.4.249 (the anchor enforced), §11.4.227(A)/(B), §11.4.201(1)/(7)(a)/(7)(b),
#   §11.4.157, §11.4.35, §11.4.251, §11.4.28/§11.4.177, §1.1 (paired mutation:
#   cm_covenant_114_249_propagation_mutation_test.sh).
#
# ── Exit codes ───────────────────────────────────────────────────────────────
...
GATE="CM-COVENANT-114-249-PROPAGATION"
