#!/usr/bin/env bash
# cm_covenant_114_213_propagation.sh — CM-COVENANT-114-213-PROPAGATION gate (FEATURE research-scheduling directive).
#
# ── Purpose ──────────────────────────────────────────────────────────────────
# §11.4.213 (FEATURE research-scheduling directive) requires the anchor
# literal `11.4.213` to be present in every owned governance context-carrier
...
# gate — modeled verbatim on cm_covenant_114_202_propagation.sh (only the
# ANCHOR/GATE constants + this header differ).
#
# ── Usage ────────────────────────────────────────────────────────────────────
#   cm_covenant_114_213_propagation.sh [--root <consumer-root>] [--quiet]
...
#
# ── Cross-references ──────────────────────────────────────────────────────────
#   §11.4.213 (FEATURE research-scheduling directive), §11.4.202 (the
#   delegated engine + reporting-directive family), §11.4.157
...
#   §11.4.95 (the DB single-source-of-truth a scheduled item lands in),
...
#   as cm_covenant_114_202_propagation.sh).
#
# ── Exit codes ───────────────────────────────────────────────────────────────
#   0 — every discovered owned carrier carries the `11.4.213` literal.
...
ANCHOR="11.4.213"
GATE="CM-COVENANT-114-213-PROPAGATION"
...
echo "✅ ${GATE}: PASS — every owned carrier carries §11.4.213"
exit 0
