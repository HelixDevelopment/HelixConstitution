#!/usr/bin/env bash
# cm_covenant_114_213_propagation.sh — CM-COVENANT-114-213-PROPAGATION gate (anchor §11.4.213).
#
# ── Purpose ──────────────────────────────────────────────────────────────────
# §11.4.227(B) anchor-block integrity for §11.4.213: the anchor's BLOCK (its
# own governance paragraph, not merely the bare literal `11.4.213`) MUST be
...
#
# ── Cross-references ─────────────────────────────────────────────────────────
#   §11.4.213 (the anchor enforced), §11.4.227(A)/(B), §11.4.201(1)/(7)(a)/(7)(b),
