#!/usr/bin/env bash
# cm_covenant_114_235_propagation_mutation_test.sh — §1.1 paired-mutation meta-test for CM-COVENANT-114-235-PROPAGATION
# (anchor §11.4.235).
#
# ── Purpose ──────────────────────────────────────────────────────────────────
# Proves CM-COVENANT-114-235-PROPAGATION is a GENUINE gate, not a bluff: it MUST
