#!/usr/bin/env bash
# cm_covenant_114_233_propagation_mutation_test.sh — §1.1 paired-mutation meta-test for CM-COVENANT-114-233-PROPAGATION
# (anchor §11.4.233).
#
# ── Purpose ──────────────────────────────────────────────────────────────────
# Proves CM-COVENANT-114-233-PROPAGATION is a GENUINE gate, not a bluff: it MUST
...
#
# ── Cross-references ─────────────────────────────────────────────────────────
#   §1.1, §11.4.233, §11.4.227(B), §11.4.201(1)/(7)(a), §11.4.157, §11.4.35,
