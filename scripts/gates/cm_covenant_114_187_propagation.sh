#!/usr/bin/env bash
# cm_covenant_114_187_propagation.sh — CM-COVENANT-114-187-PROPAGATION gate (anchor §11.4.187).
#
# ── Purpose ──────────────────────────────────────────────────────────────────
# §11.4.227(B) anchor-block integrity for §11.4.187: the anchor's BLOCK (its
# own governance paragraph, not merely the bare literal `11.4.187`) MUST be
...
#
# ── Cross-references ─────────────────────────────────────────────────────────
#   §11.4.187 (the anchor enforced), §11.4.227(A)/(B), §11.4.201(1)/(7)(a)/(7)(b),
